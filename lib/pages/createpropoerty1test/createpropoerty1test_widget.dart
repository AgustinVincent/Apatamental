...
import 'createpropoerty1test_model.dart';
export 'createpropoerty1test_model.dart';

class Createpropoerty1testWidget extends StatefulWidget {
  const Createpropoerty1testWidget({
    super.key,
    this.propertyRef,
  });
  ...
  @override
  State<Createpropoerty1testWidget> createState() =>
      _Createpropoerty1testWidgetState();
}

class _Createpropoerty1testWidgetState
    extends State<Createpropoerty1testWidget> {
  late Createpropoerty1testModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Createpropoerty1testModel());
