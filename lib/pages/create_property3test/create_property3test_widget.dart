...
import 'create_property3test_model.dart';
export 'create_property3test_model.dart';

class CreateProperty3testWidget extends StatefulWidget {
  const CreateProperty3testWidget({
    super.key,
    this.propertyRef,
  });
  ...
  @override
  State<CreateProperty3testWidget> createState() =>
      _CreateProperty3testWidgetState();
}

class _CreateProperty3testWidgetState extends State<CreateProperty3testWidget> {
  late CreateProperty3testModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateProperty3testModel());
