...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'CreateProperty3test',
          path: '/createProperty3test',
          asyncParams: {
            'propertyRef':
                getDoc(['properties'], PropertiesRecord.fromSnapshot),
          },
          builder: (context, params) => CreateProperty3testWidget(
            propertyRef: params.getParam(
              'propertyRef',
              ParamType.Document,
            ),
        ...
        FFRoute(
          name: 'Createpropoerty1test',
          path: '/createpropoerty1test',
          asyncParams: {
            'propertyRef':
                getDoc(['properties'], PropertiesRecord.fromSnapshot),
          },
          builder: (context, params) => Createpropoerty1testWidget(
            propertyRef: params.getParam(
              'propertyRef',
              ParamType.Document,
            ),
