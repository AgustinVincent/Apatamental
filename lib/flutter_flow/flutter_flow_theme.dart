...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color info = const Color(0xFF101518);

  late Color grayIcon = const Color(0xFF777777);
  late Color lineGray = const Color(0xFF2E2E2E);
  late Color gunmetal = const Color(0xFF665757);
  late Color turquoise = const Color(0xFF30D5C8);
  late Color dark600 = const Color(0xFF1E262C);
  late Color cultured = const Color(0x4D984BB6);
  late Color darkText = const Color(0xFF95A0AC);
  late Color gray600 = const Color(0xFFB5B5B5);
  late Color redApple = const Color(0xFFB30000);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF06D5CD);
  late Color secondary = const Color(0xFF18AA99);
  late Color tertiary = const Color(0xFF371246);
  ...
  late Color grayIcon = const Color(0xFF777777);
  late Color lineGray = const Color(0xFFC8C8C8);
  late Color gunmetal = const Color(0xFF665757);
  late Color turquoise = const Color(0xFF30D5C8);
  late Color dark600 = const Color(0xFF9E9494);
  late Color cultured = const Color(0x4D984BB6);
  late Color darkText = const Color(0xFFD4E1E9);
  late Color gray600 = const Color(0xFF828282);
  late Color redApple = const Color(0xFFB30000);
}
